...
| [dict-extra](http://github.com/elm-community/dict-extra) | A library with extra functions for the dictionary type in elm core | | |
...
| [elm-webpack-loader](https://github.com/elm-community/elm-webpack-loader) | Webpack loader for Elm | heyakyra | hello@kyra.run |
...
| [random-extra](http://github.com/elm-community/random-extra) | Extra functions for Random | | |
...
See [this link](https://github.com/orgs/elm-community/repositories?type=archived) for a complete list of archived and deprecated packages that exist under the `elm-community` name.
